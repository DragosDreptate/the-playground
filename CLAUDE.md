...
> - **FR** : Circle → **Communauté** (féminin : une Communauté, cette Communauté), Moment → **événement** (masculin : un événement, cet événement, Brouillon, Publié, Annulé, Passé), Host → Organisateur, Player → Participant, Register → **S'inscrire**, Dashboard → **Mon espace**, Explorer → **Découvrir**
