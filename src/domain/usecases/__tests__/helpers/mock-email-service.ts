...
export function createMockEmailService(
  ...
  return {
    ...
    sendMomentHostMessages: vi.fn().mockResolvedValue(undefined),
    ...
    sendAdminCommentPending: vi.fn().mockResolvedValue(undefined),
    ...
    sendHostCancellation: vi.fn().mockResolvedValue(undefined),
  sendCancellationConfirmation: vi.fn().mockResolvedValue(undefined),
    ...
    sendHostContactMessage: vi.fn().mockResolvedValue(undefined),
    ...overrides,
  };
}
