        ...
        <div className="mt-10 space-y-5">
          {posts.map((post) => (
            ...
            >
              ...
              <h2 className="mt-2.5 text-lg font-bold tracking-tight group-hover:text-primary dark:hover:text-[oklch(0.76_0.27_341)] transition-colors">
                {post.title}
              </h2>
              <p className="mt-1.5 text-sm leading-relaxed text-muted-foreground">
                {post.description}
              </p>
              <div className="mt-3 flex items-center gap-1.5 text-sm font-medium text-muted-foreground group-hover:text-primary dark:hover:text-[oklch(0.76_0.27_341)] transition-colors">
                {t("readMore")}
