...
describe("buildReminderEmailData", () => {
  ...
  it("should set recipient email and name", () => {
    const data = buildReminderEmailData(moment, user, "https://the-playground.fr");
  ...
  it("should fall back to email when user has no name", () => {
    const data = buildReminderEmailData(moment, { email: "bob@example.com", name: null }, "https://the-playground.fr");
  ...
  it("should include a non-empty icsContent", () => {
    const data = buildReminderEmailData(moment, user, "https://the-playground.fr");
    expect(data.icsContent).toBeTruthy();
    expect(data.icsContent).toContain("BEGIN:VCALENDAR");
    expect(data.icsContent).toContain("Weekly Meetup");
  });
  ...
  it("should format ONLINE location with video link", () => {
    ...
    const data = buildReminderEmailData(onlineMoment, user, "https://the-playground.fr");
