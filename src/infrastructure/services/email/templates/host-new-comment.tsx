...
import type { HostNewCommentEmailData } from "@/domain/ports/services/email-service";

type Props = HostNewCommentEmailData & {
  baseUrl: string;
};
...
export function HostNewCommentEmail({
  ...
  const viewUrl = `${baseUrl}/dashboard/circles/${circleSlug}/moments/${momentSlug}`;
