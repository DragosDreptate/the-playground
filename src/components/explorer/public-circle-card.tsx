      ...
      <div className="bg-card dark:bg-[oklch(0.22_0.04_281.8)] overflow-hidden rounded-2xl border p-3 sm:p-4 shadow-lg dark:shadow-none transition-colors hover:border-primary/30">
        <div className="flex items-center gap-6 sm:gap-7">
          ...
          <div className="min-w-0 flex-1 space-y-1 sm:space-y-1.5">
            ...
            <h3 className="min-w-0 truncate text-sm sm:text-base font-semibold leading-snug group-hover:text-primary dark:group-hover:text-[oklch(0.76_0.27_341)] transition-colors">
              {circle.name}
            </h3>
