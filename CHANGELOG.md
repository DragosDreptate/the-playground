...
## [1.17.0](https://github.com/DragosDreptate/the-playground/compare/the-playground-v1.16.0...the-playground-v1.17.0) (2026-03-19)


### Added

* add dashboard pending requests UI and approval email notifications ([38253d8](https://github.com/DragosDreptate/the-playground/commit/38253d89a0b075e8e08309302a08c6fcf6773909))
* approval registration — validation des inscriptions par l'Organisateur ([b8b220f](https://github.com/DragosDreptate/the-playground/commit/b8b220fdd0d928f2d39de1b30149c0bd0284c2e9))
* complete approval registration feature (D11-D15, forms, actions) ([714fbf9](https://github.com/DragosDreptate/the-playground/commit/714fbf94b36520bc1cd2ff38816501ef682ba097))
* **dashboard:** show pending Circle memberships in participant dashboard ([755760f](https://github.com/DragosDreptate/the-playground/commit/755760ffb6b32a063d224deff79ad7efcdbbad8d))
* **email:** notify host when a pending registration request is submitted ([251eabe](https://github.com/DragosDreptate/the-playground/commit/251eabef14bbd0f6a26ef743e93de9b6b39f1982))
* **schema:** add approval registration fields and secure existing membership queries ([b8e30f0](https://github.com/DragosDreptate/the-playground/commit/b8e30f0652e1cf5efa1991d8252711a0a8f45f32))
* **ui:** add server actions, registration button state, and i18n for approval flow ([73344d3](https://github.com/DragosDreptate/the-playground/commit/73344d3160a217f274bf1103b6994fc040bda09f))
* **usecases:** add approve/reject usecases for membership and registration ([f74ec42](https://github.com/DragosDreptate/the-playground/commit/f74ec42824abf6374ccea720730d55c147510091))
* **usecases:** add requiresApproval logic to join flows ([28aad6c](https://github.com/DragosDreptate/the-playground/commit/28aad6cc9518f8a6b2c1363d5052d35f1d63d982))


### Fixed

* address 6 spec gaps found during audit ([adc3671](https://github.com/DragosDreptate/the-playground/commit/adc367101bdbd9214e530284c6cb57a0338b1784))
* align spec and E2E tests after coherence audit ([f74b413](https://github.com/DragosDreptate/the-playground/commit/f74b413ed0884751fcd3bda82bef4cded5c4f3ee))
* allow dashboard moment access with active registration but no circle membership ([cedce5e](https://github.com/DragosDreptate/the-playground/commit/cedce5e2d8c2111d842db0d70a9d311ddf28eec9))
* **e2e:** fix test isolation and state dependency issues ([9fd61c2](https://github.com/DragosDreptate/the-playground/commit/9fd61c2dec49a96743e977541ca73bca6a28934c))
* **i18n:** internationaliser la page contact et la section contact de la landing ([4f86730](https://github.com/DragosDreptate/the-playground/commit/4f86730515f0056710ba5af50be8526b7e5da2d8))
* **i18n:** internationaliser tous les textes hardcodés FR ([c7d4a0b](https://github.com/DragosDreptate/the-playground/commit/c7d4a0b928ce6e8db45a7b8b9124971b31c96e56))
* **i18n:** internationaliser tous les textes hardcodés FR restants ([39c729f](https://github.com/DragosDreptate/the-playground/commit/39c729fc1d7e92753962df074d5c6263e73f2dfd))
* **i18n:** page contact et section landing entièrement traduites EN/FR ([3630874](https://github.com/DragosDreptate/the-playground/commit/36308748456eb53e80201f3e3b15a1ab414fb920))
* **i18n:** traduire les détails du lien Google Calendar ([20a7bb5](https://github.com/DragosDreptate/the-playground/commit/20a7bb59fa13ad3da7b2022e57bb662e61e7e2ee))
* **i18n:** update approval CTA label to "S'inscrire (soumis à validation)" ([e0ec45e](https://github.com/DragosDreptate/the-playground/commit/e0ec45e86457fbf2f2f756179581c17b5b62d668))
* persist requiresApproval in Prisma create and update methods ([7234bf8](https://github.com/DragosDreptate/the-playground/commit/7234bf8a2bcba852e3b0ce49281ae0eb6c09b17c))
* **ui:** align pending approval badge style with member/host badges ([fc9b4f4](https://github.com/DragosDreptate/the-playground/commit/fc9b4f4f620442f09e1037ead45f3725ac7a09f1))
* **ui:** show pending approval badge on Circle public page after join request ([22f1577](https://github.com/DragosDreptate/the-playground/commit/22f15770579da666ffdd3d87f918ea9054ceeb68))


### Changed

* **i18n:** simplifier circle-share-invite-card et restaurer bold du compteur radar ([28936bc](https://github.com/DragosDreptate/the-playground/commit/28936bc4f3551cb1e0b5f30a75c03824f6fa6a9d))
* remove stale aliases and parallelize DB calls ([77c849d](https://github.com/DragosDreptate/the-playground/commit/77c849d859e886a8850225f336e11034d91fe3f9))
* simplify code after review (reuse, quality, efficiency) ([fb47828](https://github.com/DragosDreptate/the-playground/commit/fb4782806e7dbf48d7640b7f6802b1c19f2879ad))
