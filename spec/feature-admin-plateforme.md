...
- **Modérer** en supprimant du contenu ou en forçant l'annulation d'un événement
- **Débloquer** des situations (supprimer un utilisateur problématique, nettoyer des données)

**Ce que ce n'est pas** : un outil Organisateur. Les outils Organisateur (co-Organisateurs, gestion membres, stats Communauté) sont une feature séparée, pas encore implémentée.
