#!/usr/bin/env bash
# ─────────────────────────────────────────────
# db:studio:prod — Open Prisma Studio connected
# to the Neon production branch.
#
# Usage: pnpm db:studio:prod
# ─────────────────────────────────────────────
...
echo ""
echo "⚠️  ATTENTION: You are editing the PRODUCTION database."
